const translations = {
  en: {
    ...
    footer: {
      copyright: "© 2025 sayfe - All rights reserved."
    },
    home: {
      ...
      features: {
        realtime: {
          ...
          text: "Live updates from restaurants ensure allergens are always identified."
        },
        ai: {
          title: "Smart AI Recognition",
          text: "AI detects and corrects allergy inputs for precise communication."
        },
        privacy: {
          title: "Encrypted Data",
          text: "All allergy data is securely stored and encrypted for privacy."
        }
      }
    },
    waitlist: {
      ...
      fields: {
        ...
        age: "Age",
        city: "City",
        allergy: "Primary Allergy",
        diningFrequency: "Dining Out per Month"
      },
      submit: "Join Now",
      submitting: "Submitting...",
      success: "Thank you! You're now on the waitlist.",
      ...
      founders: [
        {
          ...
          role: "Co-founder",
          bio: "Full-stack engineer obsessed with frictionless experiences and trustworthy data at scale."
        },
        {
          name: "Martim Pires",
          role: "Co-founder",
          bio: "Product strategist who keeps the team focused on creating safer dining journeys for every guest."
        },
        {
  ...
  pt: {
    ...
    footer: {
      copyright: "© 2025 sayfe - Todos os direitos reservados."
    },
    home: {
      ...
      features: {
        realtime: {
          ...
          text: "Atualizações em direto dos restaurantes garantem que os alergénios são sempre identificados."
        },
        ai: {
          title: "Reconhecimento inteligente por IA",
          text: "A IA deteta e corrige entradas sobre alergias para uma comunicação precisa."
        },
        privacy: {
          title: "Dados encriptados",
          text: "Todos os dados sobre alergias são guardados de forma segura e encriptados para proteger a privacidade."
        }
      }
    },
    waitlist: {
      ...
      fields: {
        ...
        age: "Idade",
        city: "Cidade",
        allergy: "Alergia principal",
        diningFrequency: "Refeições fora por mês"
      },
      submit: "Inscrever-me agora",
      submitting: "A enviar...",
      success: "Obrigado! Já está na lista de espera.",
      ...
      founders: [
        {
          name: "Francisco Magalhães",
          role: "Co-fundador",
          bio: "Engenheiro full-stack dedicado a criar experiências fluidas e a garantir dados fiáveis em grande escala."
        },
        {
          name: "Martim Pires",
          role: "Co-fundador",
          bio: "Estratega de produto que mantém a equipa focada em criar jornadas gastronómicas mais seguras para todos."
        },
        {
          name: "Rodrigo Azevedo",
          role: "Co-fundador",
